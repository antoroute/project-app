...
| enveloppe E2EE V2 | [`message_cipher_v2.dart`](../../frontend-mobile/flutter_message_app/lib/core/crypto/message_cipher_v2.dart), [`message_v2.dart`](../../frontend-mobile/flutter_message_app/lib/core/models/message_v2.dart) | JSON V2 | `TC-114`, `TC-301` à `TC-312` |
...
| clés de message en mémoire | [`message_key_cache.dart`](../../frontend-mobile/flutter_message_app/lib/core/services/message_key_cache.dart) | RAM | `TC-306` |
